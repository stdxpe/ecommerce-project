...
import 'package:ecommerce_project/ui/widgets/dismissible_delete_widget.dart';
  ...
  Widget build(BuildContext context) {
    return SliverPadding(
      ...
      sliver: SliverList.builder(
        ...
        itemBuilder: (context, index) => DismissibleDeleteWidget(
          uniqueKey: productList[index].title,
          child: Container(
            margin: EdgeInsets.only(
              bottom: paddingBetweenElementsMain! * 0.5,
              top: paddingBetweenElementsMain! * 0.5,
            ),
            child: Stack(
